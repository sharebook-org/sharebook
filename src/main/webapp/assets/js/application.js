...
$(document).on("click", ".js-msgGroup",
  ...
  $(function () {
    ...
    $(window).on("resize",
      ...
      $('[data-toggle="popover"]').on("click",
        function (o) {
          o.stopPropagation(),
            $($('[data-toggle="popover"]').data("bs.popover").getTipElement()).hasClass("in") ? ($('[data-toggle="popover"]').popover("hide"), $(document).off("click.app.popover")) : ($('[data-toggle="popover"]').popover("show"), setTimeout(function () {
  ...
  $(document).on("click", "[data-action=growl]",
    function (o) {
      o.preventDefault(),
  ...
  $(function () {
    ...
    function t() {
      a.off("resize.theme.nav"),
        a.off("scroll.theme.nav"),
        n.css({
          position: "",
          left: "",
          top: ""
